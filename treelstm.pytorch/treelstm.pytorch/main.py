...
def prepare_to_train(data=None, glove=None):
    ...
    vocab = Vocab(filename=sick_vocab_file, data=[Constants.PAD_WORD, Constants.UNK_WORD,
    ...
    if os.path.isfile(emb_file):
        ...
        for idx, item in enumerate([Constants.PAD_WORD, Constants.UNK_WORD, Constants.BOS_WORD,
                                    Constants.EOS_WORD]):
            emb[idx].zero_()
    ...
    return (args, best, train_dataset, dev_dataset, test_dataset, metrics, optimizer, criterion,
            model)
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        print('==> Train    Loss: {}\tPearson: {}\tMSE: {}'.format(train_loss, train_pearson,
                                                                   train_mse))
        ...
        print('==> Test     Loss: {}\tPearson: {}\tMSE: {}'.format(test_loss, test_pearson,
                                                                   test_mse))
